/**
 * MCP Server function for Lists progress update streams associated with the user account making this call.
 */
...
class Post_X_Amz_Target_Aws_Migration_Hub_List_Progress_Update_StreamsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Aws_Migration_Hub_List_Progress_Update_StreamsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("X-Amz-Target")) {
            queryParams.add("X-Amz-Target=" + args.get("X-Amz-Target"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_aws_migration_hub_list_progress_update_streams" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Aws_Migration_Hub_List_Progress_Update_StreamsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_aws_migration_hub_list_progress_update_streams",
            "Lists progress update streams associated with the user account making this call.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Aws_Migration_Hub_List_Progress_Update_StreamsHandler(config));
    }
