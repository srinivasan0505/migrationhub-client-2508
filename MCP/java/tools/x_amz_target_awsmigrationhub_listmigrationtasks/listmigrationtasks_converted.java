...
class Post_X_Amz_Target_Aws_Migration_Hub_List_Migration_TasksMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Aws_Migration_Hub_List_Migration_TasksHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("ResourceName")) {
            queryParams.add("ResourceName=" + args.get("ResourceName"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_aws_migration_hub_list_migration_tasks" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Aws_Migration_Hub_List_Migration_TasksTool(MCPServer.APIConfig config) {
        ...
        ResourceNameProperty.put("description", "");
        properties.put("ResourceName", ResourceNameProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_aws_migration_hub_list_migration_tasks",
            "<p>Lists all, or filtered by resource name, migration tasks associated with the user account making this call. This API has the following traits:</p> <ul> <li> <p>Can show a summary list of the most recent migration tasks.</p> </li> <li> <p>Can show a summary list of migration tasks associated with a given discovered resource.</p> </li> <li> <p>Lists migration tasks in a paginated interface.</p> </li> </ul>",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Aws_Migration_Hub_List_Migration_TasksHandler(config));
    }
